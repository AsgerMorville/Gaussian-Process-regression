...
def Kmat2(x1,x2):
    ...
    print("Kmat2 func w_est:", w_est)
    print("Kmat2 func mat1:", t2)
    t3 = -1.0/(2*transforml(w_est[0])**2)*torch.square(t2)
    t4 = torch.exp(t3)
    print("Kmat2 func mat:", t4)
    return t4

w_est =  torch.log(torch.exp(torch.tensor([0.3,0.04]))-1)
